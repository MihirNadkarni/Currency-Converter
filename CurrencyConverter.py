...
def RealTimeCurrencyConverter():
   ...
   # result = d.convert(float(am), from_currency, to_currency)
...
drrop1=Entry(root,font=('calibre',10,'normal'))
drrop2 = Entry(root, font=('calibre', 10, 'normal'))
...
#drrop1.grid(row=3, column=2, ipadx=10)
#drrop2.grid(row=4, column=2, ipadx=10)
